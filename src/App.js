...
const App = () => {
  ...
  //   //
  //   //     setTimeout(clearToken, 5000);
  //   //   }

  //   if (!localStorage.getItem("token")) {
  //     // If there's no token, navigate to the sign-in page
  //   }
  //   if (localStorage.getItem("token")) {
  //     // If there's no token, navigate to the sign-in page
  //     // Set a timeout to clear the token after 10 seconds
  //     const tokenExpirationTimeout = setTimeout(clearToken, 5000); // 10 seconds
        ...
        <Sidebar>
          <Routes>
            <Route element={<PrivateRoutes />}>
              ...
              />
              <Route
                path="/Settings/Floor_Setting"
                element={<Floor_Setting />}
              />
              <Route
