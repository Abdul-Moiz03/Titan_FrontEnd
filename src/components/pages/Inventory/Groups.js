...
async function deleteElement(groupAutoID) {
  try {
...
export default function Group() {
  ...
  return (
    <>
      <AddButton onClickHandle={handleOpenCreateModal} caption="Group" />
      {/* <Button onClick={handleOpenModal}>Open Create Group Modal</Button> */}
